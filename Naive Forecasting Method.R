...
end_date = ymd_hms("2016-12-30 08:00:00")
...
# write.csv(predictions_actuals, file = "predictions2017_NaiveForecasting.csv")
# write.csv(mape_dataset, file = "MAPE2017_NaiveForecasting.csv")
